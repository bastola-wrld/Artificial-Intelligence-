...
- **Environment modeling:** 5x5 London Grid with dynamic road closures and surge zones.
...
- `Baburam_Bastola_Taxi_Agent.ipynb`: Main simulation notebook.
...
- `gen_mas_results.py`: Lightweight data generator for metrics.
